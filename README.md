...
_For shorter commands, it is better to type out each command manually rather than copying directly. This helps you get accustomed to the bash and R environments._
